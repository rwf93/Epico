...
CONVERTER(convert_address_mode, SamplerAddressMode, VkSamplerAddressMode, VK_SAMPLER_ADDRESS_MODE_REPEAT,
	...
	{ SamplerAddressMode::MIRRORED_REPEAT, VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT },
	{ SamplerAddressMode::CLAMP_EDGE, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE },
	{ SamplerAddressMode::CLAMP_BORDER, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER },
);
